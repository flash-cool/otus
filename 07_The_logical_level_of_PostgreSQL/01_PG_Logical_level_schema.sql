...
-- "UC" означает, что пользователь "postgres" имеет права на создание баз данных, 
-- а "=" указывает на то, что он имеет те же права на создание таблиц в этих базах данных. 
-- "postgres" после первого знака равенства указывает на то, что эти права относятся к пользователю "postgres". 
